== jqm4gwt-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The jqm4gwt-addon addon enables blah blah...)
...
----
<dependency>
   <groupId>org.bsc.jqm4gwt</groupId>
   <artifactId>jqm4gwt-addon</artifactId>
