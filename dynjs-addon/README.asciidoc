== dynjs-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The dynjs-addon addon enables blah blah...)
...
<dependency>
   ...
   <artifactId>dynjs-addon</artifactId>
